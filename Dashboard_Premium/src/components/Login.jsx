...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#09090b] text-white relative overflow-hidden">
      {/* Luces Ambientales */}
      ...
      <motion.div 
        ...
        className="glass-card w-full max-w-md p-10 rounded-3xl relative z-10 glow-border"
      >
