      ...
      >
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Actualiza tus datos personales</p>
          </div>
        </div>

        {error && <div className="mb-4 text-red-400 text-xs font-bold bg-red-500/10 border border-red-500/20 p-2 rounded-lg">{error}</div>}
        {success && <div className="mb-4 text-emerald-400 text-xs font-bold bg-emerald-500/10 border border-emerald-500/20 p-2 rounded-lg">{success}</div>}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={saving} className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-[#FFD700] to-[#D4AF37] text-black font-black uppercase tracking-widest py-3 rounded-xl hover:scale-[1.02] transition-all disabled:opacity-50 mt-6">
