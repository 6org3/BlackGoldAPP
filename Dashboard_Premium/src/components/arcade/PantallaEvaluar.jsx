...
export default function PantallaEvaluar({ state, actions, roster = [] }) {
  ...
  return (
    <div>
      ...
      {/* Ejes de estrellas */}
      <MicroLabel color={C.text3} size={11} style={{ marginBottom: 10 }}>EVALUACIÓN SUBJETIVA · 1–5 ★</MicroLabel>
          ...
          return (
            ...
            >
              <div style={{ minWidth: 0 }}>
                ...
                <p style={{ margin: '2px 0 0', fontFamily: PIXEL, fontSize: 11, letterSpacing: '.04em', color: full ? C.gold : C.text3 }}>
                  {ax.hint}
                </p>
              </div>
      ...
      <MicroLabel color={C.text3} size={11} style={{ marginBottom: 10 }}>
