      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.5 }} className="flex items-center gap-4">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="group flex items-center space-x-2 min-h-11 px-4 rounded-control bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition duration-300"
            title="Editar Perfil"
          >
          ...
          <button
            ...
            className="group grid place-items-center min-h-11 min-w-11 rounded-control bg-white/5 hover:bg-danger/10 border border-white/10 hover:border-danger/30 transition duration-300"
            title="Cerrar sesión"
