describe('Black Gold QA Flow', () => {
  ...
  it('Navega por el flujo completo: Login -> Dashboard -> Modo Cancha -> KPIs', () => {
    ...
    // 2. DASHBOARD
    // El login ya no aterriza aquí: manda al home nativo del rol (rutaHomeParaRol,
    // /club o /sistema para esta cuenta owner/superadmin). Este spec recorre el
    // shell legacy, así que entra a /dashboard explícitamente.
