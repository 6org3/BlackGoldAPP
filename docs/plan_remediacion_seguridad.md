...
1. ⬜ **Yo:** dividir `AdminAtletas.jsx` (855 líneas), `ModoCanchaModal.jsx` (823), `MisionesPanel.jsx` (648), `App.jsx` (~393) en piezas más chicas; unificar la convención `*Page.jsx` (hoy conviven wrappers delgados y páginas-implementación completas).
