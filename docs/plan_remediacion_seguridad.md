...
7. ⬜ **Usuario+Yo:** validación por rol en la UI real (checklist en la sección 9 de la migración): atleta no ve a otros ni puede inflar su XP; padre solo ve a sus hijos; coach opera normal y puede crear plantillas (antes roto); registro público end-to-end tras el deploy.
