...
5. ✅ **Aplicada en producción (2026-07-07)** con `npx supabase db push`. Notas de la aplicación:
   ...
   - El historial remoto tenía una migración huérfana `20260705224803` (aplicada a mano el 2026-07-05 22:48, sin archivo en el repo). Se reconcilió con un stub local documentado (`20260705224803_registro_remoto_sin_archivo.sql`, patrón del stub de autor_id); su SQL real puede recuperarse con `SELECT statements FROM supabase_migrations.schema_migrations WHERE version='20260705224803'`.
