...
| **`RadarChart`** | Radar táctil de **7 pilares** (viewBox 260×215, centro 130,112, radio 82); resalta vértice `selectedKey`, llama `onSelect(key)` | `axes` `[{key,label,value 0..100}]`, `selectedKey`, `onSelect`, `accent`, `fill` | Perfil de pilares del atleta |
